...
class BottleneckBlock(nn.Layer):
    def __init__(self,
        ...
        self.conv1 = layers.RepVGGBlockBNRelu(
            in_channels=num_channels,
            out_channels=num_filters,
            kernel_size=1,
            )

        self.conv2 = layers.RepVGGBlockBNRelu(
        ...
        self.conv3 = layers.RepVGGBlockBN(
            in_channels=num_filters,
        ...
        if self.downsample:
            self.conv_down = layers.RepVGGBlockBN(
                in_channels=num_channels,
                out_channels=num_filters * 4,
                kernel_size=1,
                )
...
class BasicBlock(nn.Layer):
    def __init__(self,
        ...
        self.conv2 = layers.RepVGGBlockBN(
            in_channels=num_filters,
            out_channels=num_filters,
            kernel_size=3,
            padding=1 if not padding_same else 'same',
        ...
        if self.downsample:
            self.conv_down = layers.RepVGGBlockBNRelu(
                in_channels=num_channels,
                out_channels=num_filters,
                kernel_size=1,
                )
